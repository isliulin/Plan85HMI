...
void Settng_Bypass::updatePage()
{
    ...
    Train1CutSignal<<&this->database->data_CCU->B_TC1_BOGIE1_ISO_RQ<<&this->database->data_CCU->B_TC1_4Q1_ISO_RQ
                  <<&this->database->data_CCU->B_TC1_4Q2_ISO_RQ<<&this->database->data_CCU->B_TC1_AXLE1_ISO_RQ
                 <<&this->database->data_CCU->B_TC1_AXLE2_ISO_RQ<<&this->database->data_CCU->B_TC1_AUX1_ISO_RQ
                <<&this->database->data_CCU->B_TC1_BOGIE2_ISO_RQ <<&this->database->data_CCU->B_TC1_4Q3_ISO_RQ
               <<&this->database->data_CCU->B_TC1_4Q4_ISO_RQ <<&this->database->data_CCU->B_TC1_AXLE3_ISO_RQ
              <<&this->database->data_CCU->B_TC1_AXLE4_ISO_RQ <<&this->database->data_CCU->B_TC1_AUX2_ISO_RQ
             <<&this->database->data_CCU->B_TC1_DAMAN_ISO_RQ<<&this->database->data_CCU->B_TC1_EBRK_ISO_RQ
            <<&this->database->data_CCU->B_TC1_CPR_ISO_RQ<<&this->database->data_CCU->B_TC1_FLL_ISO_RQ;


    Train2CutSignal<<&this->database->data_CCU->B_TC2_BOGIE1_ISO_RQ<<&this->database->data_CCU->B_TC2_4Q1_ISO_RQ
                  <<&this->database->data_CCU->B_TC2_4Q2_ISO_RQ<<&this->database->data_CCU->B_TC2_AXLE1_ISO_RQ
                 <<&this->database->data_CCU->B_TC2_AXLE2_ISO_RQ<<&this->database->data_CCU->B_TC2_AUX1_ISO_RQ
                <<&this->database->data_CCU->B_TC2_BOGIE2_ISO_RQ <<&this->database->data_CCU->B_TC2_4Q3_ISO_RQ
               <<&this->database->data_CCU->B_TC2_4Q4_ISO_RQ <<&this->database->data_CCU->B_TC2_AXLE3_ISO_RQ
              <<&this->database->data_CCU->B_TC2_AXLE4_ISO_RQ <<&this->database->data_CCU->B_TC2_AUX2_ISO_RQ
             <<&this->database->data_CCU->B_TC2_DAMAN_ISO_RQ<<&this->database->data_CCU->B_TC2_EBRK_ISO_RQ
            <<&this->database->data_CCU->B_TC2_CPR_ISO_RQ<<&this->database->data_CCU->B_TC2_FLL_ISO_RQ;

    Train3CutSignal<<&this->database->data_CCU->B_TC3_BOGIE1_ISO_RQ<<&this->database->data_CCU->B_TC3_4Q1_ISO_RQ
                  <<&this->database->data_CCU->B_TC3_4Q2_ISO_RQ<<&this->database->data_CCU->B_TC3_AXLE1_ISO_RQ
                 <<&this->database->data_CCU->B_TC3_AXLE2_ISO_RQ<<&this->database->data_CCU->B_TC3_AUX1_ISO_RQ
                <<&this->database->data_CCU->B_TC3_BOGIE2_ISO_RQ <<&this->database->data_CCU->B_TC3_4Q3_ISO_RQ
               <<&this->database->data_CCU->B_TC3_4Q4_ISO_RQ <<&this->database->data_CCU->B_TC3_AXLE3_ISO_RQ
              <<&this->database->data_CCU->B_TC3_AXLE4_ISO_RQ <<&this->database->data_CCU->B_TC3_AUX2_ISO_RQ
             <<&this->database->data_CCU->B_TC3_DAMAN_ISO_RQ<<&this->database->data_CCU->B_TC3_EBRK_ISO_RQ
            <<&this->database->data_CCU->B_TC3_CPR_ISO_RQ<<&this->database->data_CCU->B_TC3_FLL_ISO_RQ;

    Train4CutSignal<<&this->database->data_CCU->B_TC4_BOGIE1_ISO_RQ<<&this->database->data_CCU->B_TC4_4Q1_ISO_RQ
                  <<&this->database->data_CCU->B_TC4_4Q2_ISO_RQ<<&this->database->data_CCU->B_TC4_AXLE1_ISO_RQ
                 <<&this->database->data_CCU->B_TC4_AXLE2_ISO_RQ<<&this->database->data_CCU->B_TC4_AUX1_ISO_RQ
                <<&this->database->data_CCU->B_TC4_BOGIE2_ISO_RQ <<&this->database->data_CCU->B_TC4_4Q3_ISO_RQ
               <<&this->database->data_CCU->B_TC4_4Q4_ISO_RQ <<&this->database->data_CCU->B_TC4_AXLE3_ISO_RQ
              <<&this->database->data_CCU->B_TC4_AXLE4_ISO_RQ <<&this->database->data_CCU->B_TC4_AUX2_ISO_RQ
             <<&this->database->data_CCU->B_TC4_DAMAN_ISO_RQ<<&this->database->data_CCU->B_TC4_EBRK_ISO_RQ
            <<&this->database->data_CCU->B_TC4_CPR_ISO_RQ<<&this->database->data_CCU->B_TC4_FLL_ISO_RQ;

    Train1CancelSignal<<&this->database->data_CCU->B_TC1_BOGIE1_ISO_REL_RQ<<&this->database->data_CCU->B_TC1_4Q1_ISO_REL_RQ
                     <<&this->database->data_CCU->B_TC1_4Q2_ISO_REL_RQ<<&this->database->data_CCU->B_TC1_AXLE1_ISO_REL_RQ
                    <<&this->database->data_CCU->B_TC1_AXLE2_ISO_REL_RQ<<&this->database->data_CCU->B_TC1_AUX1_ISO_REL_RQ
                   <<&this->database->data_CCU->B_TC1_BOGIE2_ISO_REL_RQ <<&this->database->data_CCU->B_TC1_4Q3_ISO_REL_RQ
                  <<&this->database->data_CCU->B_TC1_4Q4_ISO_REL_RQ <<&this->database->data_CCU->B_TC1_AXLE3_ISO_REL_RQ
                 <<&this->database->data_CCU->B_TC1_AXLE4_ISO_REL_RQ <<&this->database->data_CCU->B_TC1_AUX2_ISO_REL_RQ
                <<&this->database->data_CCU->B_TC1_DAMAN_ISO_REL_RQ<<&this->database->data_CCU->B_TC1_EBRK_ISO_REL_RQ
               <<&this->database->data_CCU->B_TC1_CPR_ISO_REL_RQ<<&this->database->data_CCU->B_TC1_FLL_ISO_REL_RQ;


    Train2CancelSignal<<&this->database->data_CCU->B_TC2_BOGIE1_ISO_REL_RQ<<&this->database->data_CCU->B_TC2_4Q1_ISO_REL_RQ
                     <<&this->database->data_CCU->B_TC2_4Q2_ISO_REL_RQ<<&this->database->data_CCU->B_TC2_AXLE1_ISO_REL_RQ
                    <<&this->database->data_CCU->B_TC2_AXLE2_ISO_REL_RQ<<&this->database->data_CCU->B_TC2_AUX1_ISO_REL_RQ
                   <<&this->database->data_CCU->B_TC2_BOGIE2_ISO_REL_RQ <<&this->database->data_CCU->B_TC2_4Q3_ISO_REL_RQ
                  <<&this->database->data_CCU->B_TC2_4Q4_ISO_REL_RQ <<&this->database->data_CCU->B_TC2_AXLE3_ISO_REL_RQ
                 <<&this->database->data_CCU->B_TC2_AXLE4_ISO_REL_RQ <<&this->database->data_CCU->B_TC2_AUX2_ISO_REL_RQ
                <<&this->database->data_CCU->B_TC2_DAMAN_ISO_REL_RQ<<&this->database->data_CCU->B_TC2_EBRK_ISO_REL_RQ
               <<&this->database->data_CCU->B_TC2_CPR_ISO_REL_RQ<<&this->database->data_CCU->B_TC2_FLL_ISO_REL_RQ;

    Train3CancelSignal<<&this->database->data_CCU->B_TC3_BOGIE1_ISO_REL_RQ<<&this->database->data_CCU->B_TC3_4Q1_ISO_REL_RQ
                     <<&this->database->data_CCU->B_TC3_4Q2_ISO_REL_RQ<<&this->database->data_CCU->B_TC3_AXLE1_ISO_REL_RQ
                    <<&this->database->data_CCU->B_TC3_AXLE2_ISO_REL_RQ<<&this->database->data_CCU->B_TC3_AUX1_ISO_REL_RQ
                   <<&this->database->data_CCU->B_TC3_BOGIE2_ISO_REL_RQ <<&this->database->data_CCU->B_TC3_4Q3_ISO_REL_RQ
                  <<&this->database->data_CCU->B_TC3_4Q4_ISO_REL_RQ <<&this->database->data_CCU->B_TC3_AXLE3_ISO_REL_RQ
                 <<&this->database->data_CCU->B_TC3_AXLE4_ISO_REL_RQ <<&this->database->data_CCU->B_TC3_AUX2_ISO_REL_RQ
                <<&this->database->data_CCU->B_TC3_DAMAN_ISO_REL_RQ<<&this->database->data_CCU->B_TC3_EBRK_ISO_REL_RQ
               <<&this->database->data_CCU->B_TC3_CPR_ISO_REL_RQ<<&this->database->data_CCU->B_TC3_FLL_ISO_REL_RQ;


    Train4CancelSignal<<&this->database->data_CCU->B_TC4_BOGIE1_ISO_REL_RQ<<&this->database->data_CCU->B_TC4_4Q1_ISO_REL_RQ
                     <<&this->database->data_CCU->B_TC4_4Q2_ISO_REL_RQ<<&this->database->data_CCU->B_TC4_AXLE1_ISO_REL_RQ
                    <<&this->database->data_CCU->B_TC4_AXLE2_ISO_REL_RQ<<&this->database->data_CCU->B_TC4_AUX1_ISO_REL_RQ
                   <<&this->database->data_CCU->B_TC4_BOGIE2_ISO_REL_RQ <<&this->database->data_CCU->B_TC4_4Q3_ISO_REL_RQ
                  <<&this->database->data_CCU->B_TC4_4Q4_ISO_REL_RQ <<&this->database->data_CCU->B_TC4_AXLE3_ISO_REL_RQ
                 <<&this->database->data_CCU->B_TC4_AXLE4_ISO_REL_RQ <<&this->database->data_CCU->B_TC4_AUX2_ISO_REL_RQ
                <<&this->database->data_CCU->B_TC4_DAMAN_ISO_REL_RQ<<&this->database->data_CCU->B_TC4_EBRK_ISO_REL_RQ
               <<&this->database->data_CCU->B_TC4_CPR_ISO_REL_RQ<<&this->database->data_CCU->B_TC4_FLL_ISO_REL_RQ;

    FaultReset<<&this->database->data_CCU->B_TC1_FAULT_RESET<<&this->database->data_CCU->B_TC2_FAULT_RESET
             <<&this->database->data_CCU->B_TC3_FAULT_RESET<<&this->database->data_CCU->B_TC4_FAULT_RESET;
...
{
    if(this->database->data_TCN->train[TrainIndex]->B_CMD_DDU_RESET)
    {
        *FaultReset[TrainIndex] = false;
    }else
    {
