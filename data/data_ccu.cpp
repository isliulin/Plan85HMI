...
Data_CCU::Data_CCU()
{
    ...
    B_TC1_BOGIE1_ISO_RQ = B_TC1_4Q1_ISO_RQ = B_TC1_4Q2_ISO_RQ = B_TC1_AXLE1_ISO_RQ = B_TC1_AXLE2_ISO_RQ = B_TC1_AXLE3_ISO_RQ =
    ...
    B_TC1_DAMAN_ISO_REL_RQ=B_TC1_EBRK_ISO_REL_RQ=B_TC1_CPR_ISO_REL_RQ=B_TC1_FLL_ISO_REL_RQ=B_TC1_PANTO_ISO_REL_RQ = false;
    ...
    B_TC2_DAMAN_ISO_REL_RQ=B_TC2_EBRK_ISO_REL_RQ=B_TC2_CPR_ISO_REL_RQ=B_TC2_FLL_ISO_REL_RQ=B_TC2_PANTO_ISO_REL_RQ = false;
    ...
    B_TC3_DAMAN_ISO_REL_RQ=B_TC3_EBRK_ISO_REL_RQ=B_TC3_CPR_ISO_REL_RQ=B_TC3_FLL_ISO_REL_RQ=B_TC3_PANTO_ISO_REL_RQ = false;
    ...
    B_TC4_DAMAN_ISO_REL_RQ=B_TC4_EBRK_ISO_REL_RQ=B_TC4_CPR_ISO_REL_RQ=B_TC4_FLL_ISO_REL_RQ=B_TC4_PANTO_ISO_REL_RQ = false;
    ...
    =B_NORMAL_MODE=B_SUMMER_MODE=B_AXLE_23TON=B_AXLE_25TON=B_VT_MT1_ST=B_VT_MT2_ST=B_VT_SM1_ST=B_VT_SM2_ST=B_P300CHECK0=B_P300CHECK1 = false;

     N_SIM_SPEED=N_SIM_LINE_VOLT=N_DDU_LIFE = 0;
    N_DDU_LIFE = 0;
    //0x301
     N_YEAR = 0;
     N_MONTH=N_DAY=N_HOUR=N_MINUTE=N_SECOND = 0;

    B_FLL_SET=B_TIME_SET=B_BRK_CHAR_Z=B_WHEEL_DIA_SET=B_TRAC_CHAR_H=B_TRAC_CHAR_Z=B_BRK_CHAR_H=B_LOCO_NO_SET=
    B_PARTNER_ID_SET=B_SEQUENCE_TEST=B_AIR_ELE_SET_LOCK=B_AIR_ELE_SET_UNION=B_SAND_CUT=B_DIS_SET=B_MILEAGE_RESET=B_SAND_CUT_REL = false;

     N_SPEED_SET=N_WHEEL_DIA=N_LOAD =0;

     N_DIS_VALUE=N_DDU_VX=N_DDU_VY=N_DDU_VZ;

     B_FIR_ALARM_CONFIRM=B_LOAD_SET=B_DAMAN_TEST=B_ANSC_TEST=B_MSCT_BOXING_SET=B_P301CHECK0=B_P301CHECK1;
    //0x302
     B_NSC_DISTANCE1=B_NSC_DISTANCE2=B_NSC_SET=B_DOUBLE_PG=B_TRAILER_MODE=B_DADMAN_SET=B_P302CHECK0=B_P302CHECK1;

     N_DADMAN_TIMESAPCE=N_DADMAN_TIMEALARM=N_TRAILER_MODE_SPEED=N_DOUBLE_PG_SPEED;

     N_LOCO_ID=N_PARTNER_ID;
